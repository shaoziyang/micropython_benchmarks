'''
    (No complex number version of Performance.py. Some port doesn't support complex number, so remove it from mandelbrot_test function.)

    Simple benchmark for micropython and circuitpython.

    Compare the performance of different MCUs by performing operations such as addition, multiplication, exponentiation, and pi.
